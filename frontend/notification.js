...
(function () {
  ...
  var TYPE_ICONS = {
    // 새 팔로워 — 사람+ (user-plus)
    new_follower: ['M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2', 'M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8', 'M19 8v6', 'M22 11h-6'],
  ...
  function ensureStyle() {
    ...
    var css = ''
      ...
      + '.wz-notif__ic svg{width:18px;height:18px;display:block;}'
